...
namespace Cinema.EntityFrameworkCore.Migrations
{
    public partial class data : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FilmForms = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmForms", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TypeOfFilms = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypeOfFilms", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TicketTypeCode = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    Chair = table.Column<int>(type: "int", nullable: true),
                    TicketSaleDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tickets_Customers_CustomerCode",
                        column: x => x.CustomerCode,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_Employees_EmployeeCode",
                        column: x => x.EmployeeCode,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_TicketTypes_TicketTypeCode",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TypeOfFilmCode = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FilmFormCode = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MovieName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateOfManufacture = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CinemaRoomId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Movies_FilmForms_FilmFormCode",
                        column: x => x.FilmFormCode,
                        principalTable: "FilmForms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Movies_TypeOfFilms_TypeOfFilmCode",
                        column: x => x.TypeOfFilmCode,
                        principalTable: "TypeOfFilms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "MovieScreeningDetails",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Premiere = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MovieCode = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CinemaRoomCode = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieScreeningDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieScreeningDetails_CinemaRooms_CinemaRoomCode",
                        column: x => x.CinemaRoomCode,
                        principalTable: "CinemaRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieScreeningDetails_Movies_MovieCode",
                        column: x => x.MovieCode,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_FilmFormCode",
                table: "Movies",
                column: "FilmFormCode");

            migrationBuilder.CreateIndex(
                name: "IX_Movies_TypeOfFilmCode",
                table: "Movies",
                column: "TypeOfFilmCode");

            migrationBuilder.CreateIndex(
                name: "IX_MovieScreeningDetails_CinemaRoomCode",
                table: "MovieScreeningDetails",
                column: "CinemaRoomCode");

            migrationBuilder.CreateIndex(
                name: "IX_MovieScreeningDetails_MovieCode",
                table: "MovieScreeningDetails",
                column: "MovieCode");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_CustomerCode",
                table: "Tickets",
                column: "CustomerCode");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_EmployeeCode",
                table: "Tickets",
                column: "EmployeeCode");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_TicketTypeCode",
                table: "Tickets",
